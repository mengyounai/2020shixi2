    ...
    <div class="row clearfix">
        <div class="col-md-11 column">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                <#list musicInfoPage.content as musicInfoPage>
                <tr>
                    <td>${musicInfoPage.musicId}</td>
                    <td>${musicInfoPage.musicName}</td>
                    <td><img height="100" width="100" src="${musicInfoPage.musicIcon}" alt=""></td>
                    <td>${musicInfoPage.musicTime}</td>
                    <td>${musicInfoPage.musicAuthor}</td>
                    <td>${musicInfoPage.labelType}</td>
                    <td>
                        <#if musicInfoPage.musicStatus=0>上架中
                            <a href="/bangumi//admin/music/down?musicId=${musicInfoPage.musicId}" style="color: red;">下架</a>
                        <#else >下架中
                            <a href="/bangumi//admin/music/up?musicId=${musicInfoPage.musicId}" style="color: green;">上架</a>
                        </#if>
                    </td>
                    <td>
                        <a href="/bangumi//admin/music/index?musicId=${musicInfoPage.musicId}">修改</a>
                    </td>

                </tr>
                </#list>
                <a href="/bangumi//admin/music/index">新增</a>
                </tbody>
            </table>
        </div>
    </div>
