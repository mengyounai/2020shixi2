...
<div class="head">
    <div class="P">
        <img src="${musicInfo.musicIcon}" height="150" width="150"/>
        <p style="margin-top:20px">中文名:${musicInfo.musicName}</p>
        <hr>
        <p>上映时间:${musicInfo.musicTime}</p>
        <hr>
        <p>歌手:${musicInfo.musicAuthor}</p>
        <hr>
        <p>音乐类型:${musicInfo.labelType}</p>
        <hr>


        <#if musicInfo.musicStatus=0>
    ...
    <div class="J"><h1 style="margin-left: 10%;">简介：</h1>
        <p style="font-size: 13px; width: 80%;margin: auto;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${musicInfo.musicDescription}</p></div>
