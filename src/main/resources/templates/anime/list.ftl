...
<div class="top">
    ...
    <div class="top6">
        <a href="../../admin/anime/list"><h1>更新信息</h1></a>
    </div>
    <div class="top7">
        <a href="#"><h1>添加信息</h1></a>
    </div>
...
<div class="head">
        ...
        <HR width="80%" color=#E0E0E0 SIZE=1>
        <#list animeInfoList as animeInfoList>
            <#list collectionDTOPage.content as collectionDTOPage>
                <#if animeInfoList.animeId=collectionDTOPage.animeId>
                    <#if collectionDTOPage.collectionStatus=1>
                        <div style="margin-left:80px ">

                            <a href="/bangumi//user/anime/detail?animeId=${animeInfoList.animeId}"><img src="${animeInfoList.animeIcon}" height="100" width="100" style="float: left;margin-top: 15px;"/></a>
                            <div class="P">
                                <p>${animeInfoList.animeName}</p>
                                <p>${animeInfoList.animeAuthor}</p>
                            </div>
                        </div>
                    </#if>
                </#if>
    ...
    <#list animeInfoPage.content as animeInfo>
        <div style="margin-left:80px;width: 800px;height:130px;">
            ...
            <#if result="已收藏">
                <div style="float:right; margin-right:10%; margin-top: 45px; font-size: 21px"><a href="/bangumi//user/anime/cancel?collectionId=${collectionId}" style="color: salmon">${result}</a></div>
                <HR width="80%" color=#E0E0E0 SIZE=1>
            <#else >
                <div style="float:right; margin-right:10%; margin-top: 45px; font-size: 21px"><a href="/bangumi//user/anime/create?animeId=${animeInfo.animeId}" style="color: salmon">${status}</a></div>
                <HR width="80%" color=#E0E0E0 SIZE=1>
            </#if>
        </div>
...
<#--<div style="width: 80%;margin:auto;">-->
    <#--<ul class="pagination pull" style="margin-left: 45%;">-->
        <#--<#if currentPage lte 1>-->
            <#--<li class="disabled"><a href="#">上一页</a></li>-->
        <#--<#else>-->
            <#--<li><a href="/bangumi//user/anime/list?page=${currentPage-1}&size=${size}">上一页</a> </li>-->
        <#--</#if>-->

        <#--<#list 1..animeInfoPage.getTotalPages() as index>-->
            <#--<#if currentPage==index>-->
                <#--<li class="disabled"><a href="#">${index}</a> </li>-->
            <#--<#else >-->
                <#--<li><a href="/bangumi//user/anime/list?page=${index}&size=${size}">${index}</a> </li>-->
            <#--</#if>-->
        <#--</#list>-->

        <#--<#if currentPage gte animeInfoPage.getTotalPages()>-->
            <#--<li class="disabled"><a href="#">下一页</a></li>-->
        <#--<#else>-->
            <#--<li><a href="/bangumi//user/anime/list?page=${currentPage+1}&size=&{size}">下一页</a></li>-->
        <#--</#if>-->
