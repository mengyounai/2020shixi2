    ...
    <div class="row clearfix">
        <div class="col-md-11 column">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                <#list bookInfoPage.content as bookInfoPage>
                <tr>
                    <td>${bookInfoPage.bookId}</td>
                    <td>${bookInfoPage.bookName}</td>
                    <td><img height="100" width="100" src="${bookInfoPage.bookIcon}" alt=""></td>
                    <td>${bookInfoPage.bookTime}</td>
                    <td>${bookInfoPage.bookAuthor}</td>
                    <td>${bookInfoPage.labelType}</td>
                    <td>
                        <#if bookInfoPage.bookStatus=0>上架中
                            <a href="/bangumi//admin/book/down?bookId=${bookInfoPage.bookId}" style="color: red;">下架</a>
                        <#else >下架中
                            <a href="/bangumi//admin/book/up?bookId=${bookInfoPage.bookId}" style="color: green;">上架</a>
                        </#if>
                    </td>
                    <td>
                        <a href="/bangumi//admin/book/index?bookId=${bookInfoPage.bookId}">修改</a>
                    </td>

                </tr>
                </#list>
                <a href="/bangumi//admin/book/index">新增</a>
                </tbody>
            </table>
        </div>
    </div>
