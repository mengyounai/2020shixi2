    ...
    <div class="row clearfix">
        <div class="col-md-11 column">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    <td>${peopleInfoPage.peopleId}</td>
                    <td>${peopleInfoPage.peopleName}</td>
                    <td>${peopleInfoPage.peopleSex}</td>
                    <td><img height="100" width="100" src="${peopleInfoPage.peopleIcon}" alt=""></td>
                    <td>${peopleInfoPage.peopleBirthday}</td>
                    <td>${peopleInfoPage.animeId}</td>
                    <td>
                        <a href="/bangumi//admin/people/index?peopleId=${peopleInfoPage.peopleId}">修改</a>
                    </td>

                </tr>
                </#list>
                <a href="/bangumi//admin/people/index">新增</a>
                </tbody>
            </table>
        </div>
    </div>
