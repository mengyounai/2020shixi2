...
<head>
    ...
    <style type="text/css">
        *{box-sizing: border-box;}
        ...
        .center{width: 50%; height: 1000px; margin: auto; border: 1px solid #F0F0F0;}
        .center1{width: 66%; height:1000px; float: left;}
        .center2{width: 30%; height:1000px; float: right;}
    </style>
</head>
<body>
<div class="top">
    <div class="top1">
        <a href="#"><img src="P%5BAD9_1NQEJB5BQMT1%5D~CK1.png"/> </a>
    </div>
    <div class="top2">
        <a href="#"><h1>动画</h1></a>
    </div>
...
<div class="center">
    <div class="center1">
        <h1 style="color: #FF6699; font-size: 30px; padding-left: 40px; padding-top: 20px;">注册成为Bangumi会员</h1>
        <h1 style="padding-left: 40px; padding-top: 20px;">你的用户名</h1>
        <input type="text" style="margin-left: 40px; margin-top: 20px; width: 80%;border: 1px solid #ccc;
        ...
        <input type="text" style="margin-left: 40px; margin-top: 20px; width: 80%;border: 1px solid #ccc;
                   ...
                   -o-transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;
                   transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s">
        <h1 style="padding-left: 40px; padding-top: 20px;">再次确认你的密码</h1>
        <input type="text" style="margin-left: 40px; margin-top: 20px; width: 80%;border: 1px solid #ccc;
                   padding: 7px 0px;border-radius: 3px;padding-left:5px;
                   -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075);box-shadow: inset 0 1px 1px rgba(0,0,0,.075);
                   -webkit-transition: border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;
                   -o-transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;
                   transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s">
        <h1 style="padding-left: 40px; padding-top: 20px;">你的头像</h1>
        <input type="text" style="margin-left: 40px; margin-top: 20px; width: 80%;border: 1px solid #ccc;
                   padding: 7px 0px;border-radius: 3px;padding-left:5px;
                   -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075);box-shadow: inset 0 1px 1px rgba(0,0,0,.075);
                   -webkit-transition: border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;
                   -o-transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;
                   transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s">
        <h1 style="padding-left: 40px; padding-top: 20px;">你的电子邮箱</h1>
        <input type="text" style="margin-left: 40px; margin-top: 20px; width: 80%;border: 1px solid #ccc;
                   padding: 7px 0px;border-radius: 3px;padding-left:5px;
                   -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075);box-shadow: inset 0 1px 1px rgba(0,0,0,.075);
                   -webkit-transition: border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;
                   -o-transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;
                   transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s">
        <h1 style="padding-left: 40px; padding-top: 20px;">你的手机号码</h1>
        <input type="text" style="margin-left: 40px; margin-top: 20px; width: 80%;border: 1px solid #ccc;
                   padding: 7px 0px;border-radius: 3px;padding-left:5px;
                   -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075);box-shadow: inset 0 1px 1px rgba(0,0,0,.075);
                   -webkit-transition: border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;
                   -o-transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;
                   transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s">
        <input type="submit" value="注册" style="background-color: #FF6699;color: white;margin-left: 40px;
    ...
    <div class="center2">
        <h1 style="color:#0099FF;padding-left: 40px; padding-top: 120px;">已经注册过Bangumi账户？</h1>
        <input type="submit" value="立即登录" style="background-color: #FF6699;color: white;margin-left: 40px;
